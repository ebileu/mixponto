...
describe('Departamento Model Tests', () => {
    it('Deve criar um departamento válido', async () => {
    ...
    it('Deve falhar ao criar um departamento sem descrição', async () => {
        const {empresa} = await criarBase();
        await expect(prisma.departamento.create({
            data: {
    ...
    it ('Não deve criar departamento com empresa inexistente', async () => {
        await expect(prisma.departamento.create({
            data: {
                descricao: 'Suporte',
